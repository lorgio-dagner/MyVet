...
namespace MyVet.Web.Controllers
{
    ...
    public class OwnersController : Controller
    {
        ...
        {
            // Select * From Owner InnerJoin User, Inner Join Pet
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            // Select * From Owner Inner Join User, Inner Join Pet Inner Join PetType 
            // AND Owner Inner Join User, Inner Join Pet Inner JOin Histories
            var owner = await _dataContext.Owners
                ...
                // Aqui uso FirstOrDefaultAsync para buscar el owner por id y la consulta porque contiene relaciones o InnerJoin 
        ...
        public async Task<IActionResult> Create(AddUserViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                if (response.Succeeded)
                {
                    ...
                    // Ahora aqui hago el insert
                    _dataContext.Owners.Add(owner);
                    try
                    {
                        // con la siguente instruccion recien se guarda en la BD
        ...
        public async Task<IActionResult> Delete(int? id)
        {
            ...
            {
                ModelState.AddModelError(string.Empty, "El registro no puede ser borrado");
                return RedirectToAction(nameof(Index));
            }
        ...
        public async Task<IActionResult> AddPet(int? id)
        {
            ...
            // Aqui uso FindAsync para buscar el owner por id y la consulta no contiene relaciones o InnerJoin 
        ...
        public async Task<IActionResult> DeletePet(int? id)
        {
            ...
            {
                ModelState.AddModelError(string.Empty, "The pet can´t be deleted, because its has related records.");
